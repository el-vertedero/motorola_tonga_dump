...
kernel_so_list=("/vendor/lib/modules/$GKI_PATH/fpc_mtk_tee.ko" "/vendor/lib/modules/$GKI_PATH/goodix_mtk_tee.ko")
kernel_so_name_list=("fpc_mtk_tee.ko" "goodix_mtk_tee.ko")
